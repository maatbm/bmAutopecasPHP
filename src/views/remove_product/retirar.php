    ...
    <header class="container-fluid mt-3 text-center">
        <nav class="navbar navbar-light">
            <div class="container-fluid d-flex">
                <a class="navbar-brand h1 fs-1 align-self-start">BM AUTOPEÇAS</a>
            ...
            <div class="card text-center shadow">
                ...
                <div class="card-body">
                    ...
                    <form action="update.php" method="post" autocomplete="off" style="border: solid black 2px;" class="p-2 rounded d-flex flex-column">
                        <h5 class="card-title text-warning">Quantidade a ser retirada</h5>
                        ...
                        <input type="number" name="preco" value="<?= htmlspecialchars($produto['preco']); ?>" style="display: none;">
                        <input type="submit" class="btn btn-warning mt-3" value="Retirar">
                    </form>
                </div>
            </div>
